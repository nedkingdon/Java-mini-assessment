...
public class SwampMain {
	...
	public static void main(String[] args) {
		...
		PlayerPosition currentP1 = new PlayerPosition((int) (Math.random() * 100 - 50),
		...
		while (!(currentP1.getNorthSouthLocation() == treasure.getNorthSouthT())
				&& !(currentP1.getEastWestLocation() == treasure.getEastWestT())) {

			if (currentP1.getNorthSouthLocation() - treasure.getNorthSouthT() <= 0
					&& currentP1.getEastWestLocation() - treasure.getEastWestT() <= 0) { // north east
				deg.setDegrees((90 * Math.abs(currentP1.getEastWestLocation() - treasure.getEastWestT()))
						/ (Math.abs(currentP1.getNorthSouthLocation() - treasure.getNorthSouthT())
					...
					&& currentP1.getEastWestLocation() - treasure.getEastWestT() > 0) {
				deg.setDegrees((270 * Math.abs(currentP1.getEastWestLocation() - treasure.getEastWestT()))
					...
					&& currentP1.getEastWestLocation() - treasure.getEastWestT() < 0) {
				deg.setDegrees(((90 * Math.abs(currentP1.getEastWestLocation() - treasure.getEastWestT()))
						+ 180 * Math.abs(currentP1.getNorthSouthLocation() - treasure.getNorthSouthT()))
						/ (Math.abs(currentP1.getNorthSouthLocation() - treasure.getNorthSouthT())
								+ Math.abs(currentP1.getEastWestLocation() - treasure.getEastWestT())));
			} else if (currentP1.getNorthSouthLocation() - treasure.getNorthSouthT() > 0
					&& currentP1.getEastWestLocation() - treasure.getEastWestT() > 0) {
...
//						+ "m North of the treasure");
//			} else if (currentP1.getNorthSouthLocation() - treasure.getNorthSouthT() < 0) {
//				System.out
//						.println("you are " + (Math.abs(currentP1.getNorthSouthLocation() - treasure.getNorthSouthT()))
...
//				System.out.println("you are " + (currentP1.getEastWestLocation() - treasure.getEastWestT())
//						+ "m East of the treasure");
//			}
//
//			else if (currentP1.getEastWestLocation() - treasure.getEastWestT() < 0) {
//				System.out.println("you are " + Math.abs(currentP1.getEastWestLocation() - treasure.getEastWestT())
...
//			}
			...
			System.out.println("you are "
					+ Math.round(Math.sqrt(Math.pow((currentP1.getEastWestLocation() - treasure.getEastWestT()), 2)
							+ Math.pow((currentP1.getNorthSouthLocation() - treasure.getNorthSouthT()), 2)))
